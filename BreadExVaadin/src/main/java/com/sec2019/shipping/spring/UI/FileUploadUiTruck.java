...
@Route("admin/csvuploadtrk")
public class FileUploadUiTruck extends PolymerTemplate<FileUploadUiTruck.FileUploadUiModel> {
     ...
     */
    public FileUploadUiTruck() {
        uploadTitle.setText("Upload a Truck CSV File");
